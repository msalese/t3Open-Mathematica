...
Options[t3OpenGetStatus]={IpAdrress->"127.0.0.1",HttpPort->8333};
...
Options[t3OpenGetFinanceSection]={IpAdrress->"127.0.0.1",HttpPort->8333};
...
{ipAddress,tcpPort,soTimeOut}=OptionValue[{IpAdrress,TcpPort,SoTimeOut}];
(*check argument*)
